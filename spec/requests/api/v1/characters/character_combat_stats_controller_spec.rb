...
RSpec.describe "API::V1::CharacterCombatStats", type: :request do
  ...
  describe "POST /api/v1/characters/:character_id/combat_stats" do
    ...
    context "sad paths" do
      ...
      shared_examples "returns a 400 for invalid parameter" do |param, invalid_value, error_message|
      ...
      context "invalid parameters" do
        ...
        it_behaves_like "returns 400 for invalid parameter", :conditions, [ "Poisoned!" ], "Conditions contains an invalid slug"
      end
